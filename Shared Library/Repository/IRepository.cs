...
{
    /// <summary>
    /// Provides an common interface for methods identical in strong and weakly typed 
    /// </summary>
    ...
    /// <summary>
    /// Provides a weakly typed interface for interacting with a repository of data.
    /// </summary>
    public interface IRepository : IRepositoryBase
    {
        ...
        /// </summary>
        /// <returns>An <see cref="IQueryable"/> that represents the repository.</returns>
        ...
        void Attach(Object entity, Boolean asModified);
        ...
        void AttachAll(IEnumerable entities, Boolean asModified);
    ...
    /// <summary>
    /// Provides a strongly typed interface for interacting with a repository of data.
    /// </summary>
    /// <typeparam name="TEntity">The type of entity to interact with.</typeparam>
    /// <remarks>
    ///     <para><see cref="IRepository{TEntity}"/> is designed to provide a common interface to read and write data independently of the back end persistant storage medium.</para>
    /// </remarks>
        ...
        where TEntity : class
    {
        ...
        /// Returns a representation of the repository that is queryable.
        /// </summary>
        /// <returns>An <see cref="IQueryable{TEntity}"/> that represents the repository.</returns>
